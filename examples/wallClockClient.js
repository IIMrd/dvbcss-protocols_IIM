...
program
  .version('0.0.1')
  .description(
    `UDP Wall clock client that connects to a server at the specified address (default ${HOST}) and port (default ${PORT}).`,
  )
  .arguments('[<host>] [<port>]')
...
udpSocket.on('listening', function () {
  ...
  var _wcClient = createClient(udpSocket, wallClock, protocolOptions);
