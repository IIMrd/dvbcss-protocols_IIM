...
_NOTE that the contentTime and wallClockTime values are numbers conveyed
as strings._

It might also convey that the timeline is currently _unavailable_. This can be
...
An _unavailable_ timeline is indicated by the contentTime and
...
form of an _Actual, Earliest and Latest Presentation Timestamp_. This
