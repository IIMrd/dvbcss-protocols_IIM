...
export class WallClockMessage {
  ...
  constructor(
    version: number,
    type: WallClockMessageTypes,
    precision: number,
    max_freq_error: number,
    originate_timevalue_secs: number,
    originate_timevalue_nanos: number,
    receive_timevalue: number,
    transmit_timevalue: number,
  ) {
  ...
  public static makeRequest(
    localSendtimeSecs: number,
    localSendTimeNanos: number,
  ): WallClockMessage {
   ...
   */
  public toResponse(
    responseType: WallClockMessageTypes,
    precision: number,
    max_freq_error: number,
    rxTime: number,
    txTime: number,
